  ...
  return (
    <div className="space-y-4">
      <Stage>
        ...
        {/* 塞瓦线 */}
        {res.D && <Seg a={A} b={res.D} stroke="#94a3b8" dash="4 3" />}
        {res.E && <Seg a={B} b={res.E} stroke="#94a3b8" dash="4 3" />}
        {res.F && <Seg a={C} b={res.F} stroke="#94a3b8" dash="4 3" />}
...
export function DesarguesExp({ onChallengeProgress }: ExpProps) {
  ...
  return (
    <div className="space-y-4">
      <Stage>
        {/* 透视中心连线 */}
        <LineAB a={S} b={A1} stroke="#64748b" dash="3 3" opacity={0.5} />
        <LineAB a={S} b={B1} stroke="#64748b" dash="3 3" opacity={0.5} />
        <LineAB a={S} b={C1} stroke="#64748b" dash="3 3" opacity={0.5} />
